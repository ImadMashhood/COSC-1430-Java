...
public class NLPService implements StockPriceService {
    ...
    NLPService(){
        ...
        try{
            sc = new Scanner(new FileInputStream("NLPService.txt")); //checks to see if it can read NLPService.txt
        }
        catch (FileNotFoundException e){
            System.out.println("File NLPService.txt not found closing program");
            System.exit(0);
        }
