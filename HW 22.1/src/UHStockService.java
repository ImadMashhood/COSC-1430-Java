...
public class UHStockService implements StockPriceService {
    ...
    UHStockService(){
        ...
        try{
            sc = new Scanner(new FileInputStream("UHStockService.txt")); //checks to see if it can read UHStockService.txt
        }
        catch (FileNotFoundException e){
            System.out.println("File UHStockService.txt not found closing program");
            System.exit(0);
        }
    ...
    public String nameOfService(){
        return "UH";
    } //i hate having to wait 5 min to resubmit becuase i ctrl+f wrong
